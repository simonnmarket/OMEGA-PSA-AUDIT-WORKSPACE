...
**Atualização:** 2026-06-27 — COUNCIL-RESOLUTION-001: padrão oficial de documentação e deliberação ratificado; hierarquia documental, regra de singularidade, regra de versionamento e separação de responsabilidades institucionalizadas
**Atualização:** 2026-06-27 — COUNCIL-DIRECTIVE-030: autorização geral para execução da ETAPA 3.5; COUNCIL-DIRECTIVE-029-REVISAO-CEO arquivado; CONFLICT-REGISTRY-001 resolvido pela Alternativa C
